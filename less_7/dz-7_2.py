...
coat = Coat(10)
costume = Costume(2)
print(f'Расход ткани для пальто - {coat.consum:.2f}')
print(f'Расход ткани для костюма - {costume.consum:.2f}')
print(f'Общий расход ткани - {coat.consum+costume.consum:.2f}')
